  ...
  return (
    <div>
      ...
      <div className="relative">
        {value ? (
          <div
            className={`relative ${sizeClasses[size]} rounded-2xl overflow-hidden border-2 border-gray-200 group`}
          >
          ...
          <label
            className={`flex flex-col items-center justify-center ${sizeClasses[size]} border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer hover:border-red-500 hover:bg-red-50 transition-all group`}
          >
            {uploading ? (
              <Loader2 className="w-6 h-6 text-red-500 animate-spin" />
            ) : (
              <>
                <div className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center mb-2 group-hover:bg-red-100 transition-colors">
                  <Camera className="w-5 h-5 text-gray-400 group-hover:text-red-500 transition-colors" />
                </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-800 to-[#0B0B0F]">
      ...
      <div className="bg-black/40 backdrop-blur-3xl border-b border-white/10 sticky top-0 z-10">
        <div className="max-w-2xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <button
              onClick={handleBack}
              className="p-2.5 hover:bg-gray-900 rounded-xl transition-colors"
            >
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                <ImageUpload
                  ...
                  value={
                    isPersonal
                      ? siteData.content.profilePhoto
                      : siteData.content.logo
                  }
                  onChange={(v) =>
                    updateSiteData(
                      isPersonal ? "content.profilePhoto" : "content.logo",
                      v
                    )
                  }
                ...
                <div className="flex-1 space-y-4 w-full">
                  <div>
                    ...
                    >
                      {isPersonal ? "Your Name" : "Brand Name"}{" "}
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSiteData("content.name", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSiteData("content.tagline", e.target.value)
                      }
                      placeholder={
                        isPersonal
        ...
        {currentStep === 1 && (
          <div className="space-y-4">
            <p className="text-sm text-white mb-6">
              Toggle the sections you want on your website. You can always
              change this later.
            </p>
            ...
            >
              <GalleryEditor
                ...
                onChange={(images) =>
                  updateSiteData("sections.gallery.images", images)
                }
              />
            </SectionToggle>
            ...
            >
              <ArrayInput
                ...
                onChange={(links) =>
                  updateSiteData("sections.videos.links", links)
                }
            ...
            >
              <ServicesEditor
                ...
                onChange={(items) =>
                  updateSiteData("sections.services.items", items)
                }
              />
            </SectionToggle>
            ...
            >
              <div className="space-y-3">
                <Input
                  ...
                  onChange={(e) =>
                    updateSiteData("sections.location.address", e.target.value)
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateSiteData("sections.location.mapLink", e.target.value)
                  }
                ...
                <div className="space-y-4">
                  <div className="flex gap-4 items-start">
                    <ImageUpload
                      ...
                      onChange={(v) =>
                        updateSiteData("sections.founder.photo", v)
                      }
                      type="founder"
                      size="sm"
                    />
                    <div className="flex-1">
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          updateSiteData("sections.founder.bio", e.target.value)
                        }
            ...
            >
              <div className="grid grid-cols-2 gap-3">
                {Object.entries(siteData.sections.social.links).map(
                  ([key, value]) => (
                    <div key={key}>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSiteData("sections.cta.whatsapp", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateSiteData("sections.cta.phone", e.target.value)
                    }
                    placeholder="+91 98765 43210"
                  />
                </div>
        ...
        <div className="mt-8 flex justify-between items-center">
          <button
            onClick={handleBack}
            className="text-white hover:text-gray-500 font-medium flex items-center gap-2"
          >
          ...
          <Button
            onClick={handleNext}
            size="lg"
            className="px-8 bg-gradient-to-r hover:from-[#2A0F18] hover:to-red-900 from-red-700 to-gray-700 border-1 border-red-50"
          >
  ...
  return (
    <div
      className={`bg-white rounded-2xl border overflow-hidden transition-all ${
        enabled ? "border-gray-200 shadow-sm" : "border-gray-100"
      }`}
    >
...
function GalleryEditor({ images, onChange }) {
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <label className="w-24 h-24 border-2 border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center cursor-pointer hover:border-red-500 hover:bg-red-50 transition-all">
        {uploading ? (
          <Loader2 className="w-6 h-6 text-red-500 animate-spin" />
        ) : (
          <>
